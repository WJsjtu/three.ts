...
/* harmony import */var _core_Object3D__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(/*! ../core/Object3D */"./src/core/Object3D.ts");
/* harmony import */var _Light__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(/*! ./Light */"./src/lights/Light.ts");class HemisphereLight extends _Light__WEBPACK_IMPORTED_MODULE_1__["Light"]{constructor(skyColor,groundColor,intensity){super(skyColor,intensity);this.type="HemisphereLight";this.castShadow=false;this.groundColor=null;this.groundColor=groundColor;this.position=_core_Object3D__WEBPACK_IMPORTED_MODULE_0__["Object3D"].DefaultUp.clone();this.updateMatrix()}copy(source){super.copy(source);this.groundColor.copy(source.groundColor);return this}}
/***/},
/***/"./src/lights/Light.ts":
/*!*****************************!*\
  !*** ./src/lights/Light.ts ***!
...
/**
         ...
         * @type {number}
         */this.shadowSide=null;this.side=_constants__WEBPACK_IMPORTED_MODULE_0__["FrontSide"];this.transparent=false;this.userData={};
/**
...
/**
         ...
         */this.index0AttributeName=null;this.setValues(parameters)}copy(source){this.fragmentShader=source.fragmentShader;this.vertexShader=source.vertexShader;this.uniforms=_renderers_shaders_UniformsUtils__WEBPACK_IMPORTED_MODULE_0__["UniformsUtils"].clone(source.uniforms);this.defines=source.defines;this.wireframe=source.wireframe;this.wireframeLinewidth=source.wireframeLinewidth;this.lights=source.lights;this.clipping=source.clipping;this.skinning=source.skinning;this.morphTargets=source.morphTargets;this.morphNormals=source.morphNormals;this.extensions=source.extensions;return this}}
/***/},
...
// What do we want? intersection point on the ray or on the segment??
// point: raycaster.ray.at( distance ),
point:interSegment.clone().applyMatrix4(this.matrixWorld)})}}return intersects}clone(){return new this.constructor(this.geometry,this.material).copy(this)}}
/***/},
...
const matrix=bones[i]?bones[i].matrixWorld:identityMatrix;offsetMatrix.multiplyMatrices(matrix,boneInverses[i]);offsetMatrix.toArray(boneMatrices,i*16)}if(boneTexture!==undefined){boneTexture.needsUpdate=true}}getBoneByName(name){for(let i=0,il=this.bones.length;i<il;i++){const bone=this.bones[i];if(bone.name===name){return bone}}return null}clone(){return new this.constructor(this.bones,this.boneInverses)}}
/***/},
